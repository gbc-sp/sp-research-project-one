...
class HelpPage extends Component {
  ...
  state = {
    allQuestions: [
      {q: `What is Skillpod?`, a: `Skillpod is a platform that allows you to build a repertoire of skills useful in your working and personal life. By using Skillpod, you will be able to think and learn more effectively as well as manage your own learning needs more effectively. By using Skillpod you provide evidence of your skills to potnetial employers and talk about your skills with confidence.`},
      {q: `Wahtever`, a:`Something else`},
      {q: `Third question`, a:`third qieston sdfsfsfs sdf sfs f`},
    ]
  }
    ...
    return (
      <main className="layout">
        ...
        <div className="tile limit-width">
          ...
          {/* <FAQuestion 
            oneQ = { this.state.allQuestions[0].q } 
            oneA = { this.state.allQuestions[0].a } /> */}

          { this.state.allQuestions.map(  oneQuestion => <FAQuestion oneQ={oneQuestion.q} oneA={oneQuestion.a} />  )}
